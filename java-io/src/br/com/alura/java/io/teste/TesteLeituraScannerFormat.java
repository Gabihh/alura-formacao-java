...
//			System.out.println(linha);
			...
			linhaScanner.useLocale(Locale.US);//definir as regras segundo uma determinada região
			...
			//String valorFormatado = String.format("Conta: %s - Agência: %04d - Número: %08d - Titular: %s - Saldo: R$%5.2f", conta, agencia, numero, titular, saldo);
